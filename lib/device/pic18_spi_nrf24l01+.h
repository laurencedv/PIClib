...
#ifndef _PIC18_SPI_NRF24L01_H
#define _PIC18_SPI_NRF24L01_H
...
#define		NRF_MSSP_PORT				0					//nRF is on the MSSP1
...
// -- nRF Constant -- //
#define		NRF_DLY_STBtoACTV			130					// Standby to RX or TX delay
#define		NRF_DLY_PWDtoSTB			4500				// Power Down to Standby delay (worst case with a Crystal) (150 if using external clock)
#define		NRF_DLY_CE_PULSE			10					// Minimum high time for a CE pulse to be valid
#define		NRF_DLY_CEtoSS				4					// Minimum time between a rising on CE and a falling on SS
// ------------------ //
